...
namespace ApiPeliculas.Repositorio
{
    public class UsuarioRepositorio : IUsuarioRepositorio
    {
        ...
        public UsuarioRepositorio(
            ApplicationDbContext bd, IConfiguration config, 
        ...
        public async Task<UsuarioLoginRespuestaDto> Login(UsuarioLoginDto usuarioLoginDto)
        {
            ...
            // Validamos si el ususario no existe con la combinación de usuario y contraseña correcta
            if (usuario == null || isValida == false ) return new UsuarioLoginRespuestaDto()
            {
                Token = "",
                Usuario = null
            };

            // Aquí existe el usuario entonces procedemos a procesar el login
